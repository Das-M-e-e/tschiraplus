...
public class TestTaskSortingManager
{
    ...
    public void Setup()
    {
        ...
        [
            new TaskDto
            {
                TaskId = Guid.NewGuid(), Title = "B Task", StartDate = new DateTime(2024, 1, 10),
                DueDate = new DateTime(2024, 2, 1), Status = "InProgress"
            },
            new TaskDto
            {
                TaskId = Guid.NewGuid(), Title = "A Task", StartDate = new DateTime(2024, 1, 5), DueDate = null,
                Status = "Ready"
            },
            new TaskDto
            {
                TaskId = Guid.NewGuid(), Title = "C Task", StartDate = new DateTime(2024, 1, 15),
                DueDate = new DateTime(2024, 3, 1), Status = "InProgress"
            }
        ];
    }
